 ...
 public static  class doinfo
    {
        ...
        /// </summary>
        /// <returns></returns>
     public static List<showinfo>touser(this object _obj)
     {
         List <showinfo > list=new List <showinfo >();
      ...
      public static int updateuser(this List<showinfo > list)
        {
            var row = 0;
