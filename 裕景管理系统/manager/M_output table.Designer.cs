namespace 裕景管理系统.manager
{
    partial class M_output_table
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "M_output_table";
            this.Text = "裕锦公司---导出数据表";
            this.Load += new System.EventHandler(this.M_output_table_Load);
